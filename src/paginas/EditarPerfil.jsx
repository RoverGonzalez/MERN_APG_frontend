    ...
    <>
        ...
        <div className="flex justify-center text-center">
            <div className="w-full md:w-1/2 bg-white shadow rounded-3xl p-5">
                ...
                >
                    <div className="my-3">
                        <label htmlFor="" className="uppercase font-bold text-gray-600">Nombre
                            <input 
                                type="text"
                    ...
                    <div className="my-3">
                        <label htmlFor="" className="uppercase font-bold text-gray-600">Sitio Web
                            <input 
                                type="text"
                                className="border bg-gray-50 w-full p-2 mt-5 rounded-3xl text-center text-black"
                                name="web"
                    ...
                    <div className="my-3">
                        <label htmlFor="" className="uppercase font-bold text-gray-600">Telefono
                            <input 
                                type="text"
                                className="border bg-gray-50 w-full p-2 mt-5 rounded-3xl text-center text-black"
                                name="telefono"
                    ...
                    <div className="my-3">
                        <label htmlFor="" className="uppercase font-bold text-gray-600">Email
                            <input 
                                type="text"
                                className="border bg-gray-50 w-full p-2 mt-5 rounded-3xl text-center text-black"
                                name="email"
